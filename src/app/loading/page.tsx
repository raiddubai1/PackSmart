      ...
      <div className="max-w-md w-full text-center">
        <div className="mb-8">
          <div className="relative w-24 h-24 mx-auto mb-6">
            <div className="absolute inset-0 bg-[#ffd166] rounded-full animate-ping opacity-20"></div>
            <div className="relative w-full h-full bg-[#ffd166] rounded-full flex items-center justify-center">
        ...
        <div className="bg-gray-800 rounded-lg p-6 shadow-lg mb-6">
          <div className="mb-4">
            ...
            <div className="w-full bg-gray-700 rounded-full h-2">
              <div 
                className="bg-[#ffd166] h-2 rounded-full transition-all duration-300 ease-out"
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 text-sm">
              ...
              <span className="text-gray-300">Analyzing destination and weather</span>
            </div>
            <div className="flex items-center gap-3 text-sm">
              <Calendar className="h-4 w-4 text-[#ffd166]" />
              <span className="text-gray-300">Calculating trip duration needs</span>
            </div>
            <div className="flex items-center gap-3 text-sm">
              <Users className="h-4 w-4 text-[#ffd166]" />
              <span className="text-gray-300">Customizing for traveler profiles</span>
            </div>
            <div className="flex items-center gap-3 text-sm">
              <Package className="h-4 w-4 text-[#ffd166]" />
              <span className="text-gray-300">Generating categorized packing list</span>
            </div>
          </div>
        </div>

        <div className="bg-yellow-900/20 rounded-lg p-4">
          <h3 className="font-medium text-yellow-100 mb-2">
            💡 Travel Tip
          </h3>
        ...
        <div className="mt-6">
          <Loader2 className="h-6 w-6 animate-spin mx-auto text-[#ffd166]" />
        </div>
      </div>
    </div>
  );
